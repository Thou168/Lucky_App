...
public class StoreActivePostListAdapter extends RecyclerView.Adapter<BaseViewHolder> {
    private static final String TAG=StoreActivePostListAdapter.class.getSimpleName();
    ...
    public StoreActivePostListAdapter(List<StorePostViewModel> postList,String mView){
    ...
    public class ViewHolder extends BaseViewHolder{
        ...
        public void onBind(int position){
            ...
            final StorePostViewModel data=mPostList.get(position);
            Service api=Client.getClient().create(Service.class);
            Call<Item> model=api.getDetailpost(data.getPost());
            model.enqueue(new retrofit2.Callback<Item>() {
                @Override
                public void onResponse(Call<Item> call, Response<Item> response) {
                    if(response.isSuccessful()){

                        Item mPost=response.body();
                        ...
                        itemView.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                Log.e("TAG","Store Post List click detail "+mPost.getId());
                        ...
                        try{
                            Service api = Client.getClient().create(Service.class);
                            Call<User> call1 = api.getuser(mPost.getCreated_by());
