...
//end
        ...
        supportFragmentManager.beginTransaction().replace(R.id.content, Buy_vehicle()).commit()
                ...
                R.id.notification -> {
                    if (sharedPref.contains("token") || sharedPref.contains("id")) {
                        ...
                        if (active.equals("false")){
                            ...
                            val intent = Intent(this@New_Main1, NotificationActivity::class.java)
                            startActivity(intent)
                            overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left)
                        }
                    }else{
                        val intent = Intent(this@New_Main1, UserAccountActivity::class.java)
                        startActivity(intent)
                        overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left)
                    }
                }
                ...
                R.id.message -> {
                    if (sharedPref.contains("token") || sharedPref.contains("id")) {
                        if (active.equals("false")){
                            ...
                            val intent = Intent(this@New_Main1, ChatMainActivity::class.java)
                            startActivity(intent)
                            overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left)
                        }
                    }else{
