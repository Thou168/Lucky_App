...
import com.bt_121shoppe.motorbike.Buy_Sell_Rent.Sell.Sell_eletronic
...
//end
        ...
        supportFragmentManager.beginTransaction().replace(R.id.content, Sell_eletronic()).commit()
            ...
            when (item.itemId) {
                ...
                R.id.notification -> {
                    if (sharedPref.contains("token") || sharedPref.contains("id")) {
                        ...
                        val intent = Intent(this@Sell_Main2, UserAccountActivity::class.java)
                        startActivity(intent)
                        overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left)
                    }
                }
                ...
                R.id.message -> {
                    if (sharedPref.contains("token") || sharedPref.contains("id")) {
                        if (active.equals("false")){
                            ...
                            val intent = Intent(this@Sell_Main2, ChatMainActivity::class.java)
                            startActivity(intent)
                            overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left)
                        }
                    }else{
