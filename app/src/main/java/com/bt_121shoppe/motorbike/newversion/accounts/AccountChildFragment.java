...
public class AccountChildFragment extends Fragment {
    ...
    public static AccountChildFragment newInstance(int position){
        Bundle args=new Bundle();
        args.putInt(ARGUMENT_POSITION,position);
        AccountChildFragment fragment=new AccountChildFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_account_child, container, false);
    }
    ...
    private static class GooglePlusFragmentPageAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            return AccountSubChildFragment.newInstance(position);
        }
