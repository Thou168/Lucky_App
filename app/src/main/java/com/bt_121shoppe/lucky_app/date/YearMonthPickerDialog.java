package com.bt_121shoppe.lucky_app.date;
...
//        final NumberPickerWithColor monthPicker =(NumberPickerWithColor) contentView.findViewById(R.id.month_picker);
...
//        monthPicker.setDisplayedValues(monthsList());
        ...
        setCurrentDate(mYearPicker, mYearValue);

        //Setting all listeners.
        setListeners(mYearPicker, mYearValue);
...
//        monthPicker.setValue(mMonth);
     ...
     * @param yearValue   year value in the dialog title.
     */
    private void setListeners(final NumberPickerWithColor yearPicker, final TextView yearValue) {
